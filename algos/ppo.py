from algos.network import Actor, Critic
...
class PPO(nn.Module):
    def __init__(self, device, state_dim, action_dim, args):
        ...
        self.actor = Actor(self.args.layer_num_actor, state_dim, action_dim, self.args.hidden_dim_actor, \
                           self.args.activation_function,self.args.last_activation_mu, self.args.last_activation_std)
        self.critic = Critic(self.args.layer_num_critic, state_dim, 1, \
                             self.args.hidden_dim_critic, self.args.activation_function,self.args.last_activation_value)
